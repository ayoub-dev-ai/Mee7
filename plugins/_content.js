...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/ANGILO856122/rwa/master/official_accounts.json')  
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: ' mee6 ', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
