...
users[who].exp += xp
conn.reply(m.chat,  `[ 𝙀𝙓𝙋 ⚡]\n*FOR :*\n ${text}\nNOW YOU HAVE*\n*${xp} EXP*`, m, {contextInfo: {mentionedJid: conn.parseMention(text)}})
} catch (e) {
...
handler.tags = ['xp']
handler.command = ['añadirxp', 'añadirexp', 'añadirexperiencia', 'darexperiencia', 'addxp', 'darexp'] 
handler.group = true
handler.rowner = true
